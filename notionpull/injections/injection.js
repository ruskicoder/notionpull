...
const toggleButtons = document.getElementsByClassName('notionpull-toggle-button')
for (toggleButton of toggleButtons) {
    const toggleId = toggleButton.getAttribute('notionpull-toggle-id')
    const toggleContent = document.querySelector(
        `.notionpull-toggle-content[notionpull-toggle-id='${toggleId}']`
    )
 ...
 */
const anchorLinks = document.querySelectorAll('a.notionpull-anchor-link')
